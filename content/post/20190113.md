---
title: "関数式とArrow Functionについて整理する"
...
前回の記事（[JavaScriptのthisをわかりやすく整理する（Arrow Function編）](http://mom0tomo.github.iopost/20190109/)）ではArrow Functionにおけるthisの挙動について整理しましたが、今回はArrow Function自体について整理します。
...
- thisを静的に決定する ([前回の記事で詳しく書きました](http://mom0tomo.github.iopost/20190109/))
